...
rho_r=([float(2600),float(1350),float(1100),float(920)])
    
#print (rho_r) 
R=[]
for i in range(0,2850000,50000):
    for j in range(i,2850000,50000):
        R.append([float(i),float(j),float(2850000),float(3000000)])
...
index=[]
for i in range(0,len(C)):
    if (abs(hmotnost[i][0]-M)<1E20) and (abs(MoI_computed[i]-MoI)<0.004):
        print (i)
        index.append(i)
